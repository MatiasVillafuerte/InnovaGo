...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage('¡Registro exitoso! Revisa tu correo para el código de verificación.')
      setTimeout(() => {
      ...
      if (error.response?.data?.errors) {
        ...
        setErrors({ general: error.response?.data?.message || 'Error al registrar usuario' })
      }
    } finally {
      setLoading(false)
    }
