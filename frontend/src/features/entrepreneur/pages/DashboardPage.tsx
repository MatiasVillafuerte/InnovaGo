  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500">Resumen general de tu emprendimiento</p>
      </div>
        ...
        <Card>
          ...
          <div className="space-y-4">
            {messages.slice(0, 3).map((msg) => (
              <div key={msg.id} className="flex gap-3 border-b border-slate-100 pb-4 last:border-0">
                ...
                <div className="min-w-0 flex-1">
                  <p className="truncate text-sm font-medium text-slate-900">{msg.sender}</p>
      ...
      <Card>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {products.filter((p) => p.published).slice(0, 4).map((product) => (
            <div key={product.id} className="group overflow-hidden rounded-lg border border-slate-200">
              <img
