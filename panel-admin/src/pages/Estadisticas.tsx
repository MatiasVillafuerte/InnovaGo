...
export function Estadisticas() {
  return (
    <div>
      <PageHeader
        title="Estadísticas"
        description="Métricas y análisis detallado de la plataforma"
      />
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={emprendimientosMasVisitados} layout="vertical">
              ...
              <Bar dataKey="visitas" fill="#10b981" radius={[0, 4, 4, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={registrosMensuales}>
              ...
              <YAxis tick={{ fontSize: 12, fill: '#64748b' }} />
              <Tooltip contentStyle={{ borderRadius: '8px', border: '1px solid #e2e8f0', fontSize: '13px' }} />
              <Area type="monotone" dataKey="registros" stroke="#2563eb" fill="#dbeafe" strokeWidth={2} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={usuariosActivosMensual}>
              ...
              <YAxis tick={{ fontSize: 12, fill: '#64748b' }} />
              <Tooltip contentStyle={{ borderRadius: '8px', border: '1px solid #e2e8f0', fontSize: '13px' }} />
              <Line type="monotone" dataKey="activos" stroke="#10b981" strokeWidth={2} dot={{ fill: '#10b981', r: 4 }} />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        {[
          ...
          { label: 'Tasa de Retención', value: '68%', color: 'text-purple-600' },
