      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative hidden sm:block">
          ...
          <input
            type="search"
            placeholder="Buscar..."
            className="w-64 rounded-lg border border-slate-200 bg-slate-50 py-2 pl-10 pr-4 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 lg:w-80"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="ml-2 flex items-center gap-3 border-l border-slate-200 pl-4 dark:border-slate-700">
          <img
            ...
            className="h-9 w-9 rounded-full bg-slate-100 ring-2 ring-primary-100 dark:ring-primary-900"
          />
          <div className="hidden md:block">
            <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{entrepreneur.name}</p>
